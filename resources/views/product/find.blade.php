...
<body>
    ...
    <section id="products" class="pt-5 container px-4 px-lg-5 mt-5">
        <p href="#" class="text-center h2 mt-2 fw-bolder font-monospace text-danger">
            <span class="text-danger text-capitalize fw-bolder font-monospace">Cari</span>
            <span class="text-success text-capitalize fw-bolder font-monospace">Produk</span>
            <span class="text-primary text-capitalize fw-bolder font-monospace">atau</span>
            <span class="text-warning text-capitalize fw-bolder font-monospace">Katalog</span>
        </p>
            ...
            <div class="col-md-8 col-lg-10">
                <form action="{{ route('landing.find') }}" method="GET" class="d-flex">
                    ...
                    <input type="text" class="form-control"
                        placeholder="Cari Produk Berdasarkan Nama produk atau harga" name="search"
