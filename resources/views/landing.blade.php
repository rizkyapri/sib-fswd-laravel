...
<head>
    ...
    <title>UchiStore - One Stop Shopping</title>
    <!-- Favicon-->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="#!">UchiStore</a>
    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                @foreach ($products as $product) {{-- perulangan untuk memanggil data pada products --}}
                    <div class="col mb-5">
                        <div class="card h-100">
                            @if ($product['sale_price'] != 0) {{-- mengecek jika sale_price tidak sama dengan 0 maka barang akan sale --}}
                                <!-- Sale badge-->
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    ...
                                    <div class="d-flex justify-content-center small text-warning mb-2">
                                        @for ($i = 0; $i < $product['rating']; $i++) {{-- melakukan perulangan jika i kurang dari rating maka akan bertambah --}}
                                            <div class="bi-star-fill"></div>
                                        @endfor
                                    </div>
                                    <!-- Product price-->
                                    @if ($product['sale_price'] != 0)  {{-- jika sale_price tidak sama dengan nol maka akan mencetak harga sesuai dengan kondisi sale --}}
